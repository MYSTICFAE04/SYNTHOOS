...
class MemoryComponent(Component):
    ...
    description = "Stores or retrieves stored chat messages from SynthoOS tables or an external memory."
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="Retrieve messages from an external memory. If empty, it will use the SynthoOS tables.",
            advanced=True,
        ),
        DropdownInput(
            name="sender_type",
