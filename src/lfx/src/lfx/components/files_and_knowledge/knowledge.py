...
class KnowledgeComponent(Component):
    ...
    description = "Ingest into or retrieve from a SynthoOS knowledge base."
    icon = "database"
    name = "Knowledge"
            ...
            default_factory=lambda: {
                "data": {
                    "node": {
                        ...
                        "description": "Create new knowledge in SynthoOS.",
                        ...
                        "template": {
                            ...
                            "02_embedding_model": ModelInput(
                                ...
                                info=(
                                    ...
                                    "SynthoOS uses the configured credentials for that model provider."
                                ),
                                required=True,
    ...
    async def _create_knowledge_base_record(
        ...
        *,
        ...
        """Persist the component-created KB in the DB when SynthoOS is available."""
        try:
