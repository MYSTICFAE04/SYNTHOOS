...
async def run(
    ...
    *,
    ...
    """Execute a SynthoOS graph script or JSON flow and return the result.

    This command analyzes and executes either a Python script containing a SynthoOS graph,
