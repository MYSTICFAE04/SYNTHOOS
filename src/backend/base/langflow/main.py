...
def get_lifespan(*, fix_migration=False, version=None):
    ...
    async def lifespan(_app: FastAPI):
        ...
        # Startup message
        if version:
            await logger.adebug(f"Starting SynthoOS v{version}...")
        else:
            await logger.adebug("Starting SynthoOS...")
        ...
        try:
            ...
            try:
                ...
                with shutdown_progress.step(4):
                    await logger.adebug("SynthoOS shutdown complete")
...
def get_static_files_dir():
    """Get the static files directory relative to SynthoOS's main.py file."""
