...
OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the SynthoOS Assistant and can only help with "
    "SynthoOS-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about SynthoOS?"
)
...
Respond with a complete, valid SynthoOS component as a Python class extending Component, \
